...
namespace BCAFT
{
    class CommonFunctions : ConfigClass
    {
        CommonLibraries objCommLib;
        public CommonFunctions(HelperClass helperClass)
            : base(helperClass)
        {
        ...
        public void waitForElementToBeClickable(IWebElement ele, int timeoutInSeconds, String strEleName)
        {
            try
            {
        ...
        public void select(By by, String elementName)
        {
            ...
            if (strValue != null && !strValue.Equals("") && !strValue.Equals("NULL", StringComparison.InvariantCultureIgnoreCase))
            {
                do
                {
                    if (timeOut > 0)
        ...
        public IWebElement find(IWebElement parentEle, By by, string strElementNameInUI)
        {
            IWebElement wElement = null; int timeOut = 0;
            if (parentEle != null)
            {
        ...
        public void waitTillPageload_UKVI(int timeOut)
        {
            do
            {
                try
